<?php
		//fonctions pour un usage plus simple de mysql (récup de papa tout son site tourne avec ces petites fonctions que lui même a récupéré auprès d'un pote développeur)
			include 'sql.php'; 
