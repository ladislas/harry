...
<head>	
	...
	<meta name="description" content="Harrywishyouwell.com is a new tool that provides users a secure way to take secret notes">
	...
	<!-- ========================================= -->
	<!-- TO BE UPDATED WHEN THE ICONS ARE DESIGNED -->
	<!-- ========================================= -->
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-39424166-1']);
